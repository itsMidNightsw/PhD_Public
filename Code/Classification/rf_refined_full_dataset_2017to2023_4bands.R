...
#p2pa <- predict(rfpa, test, type = "prob")
#plot(p2pa[,1])
...
#p2pa2017 <- predict(rfpa, test2017)
#confusionMatrix(p2pa2017, test2017$pre_abs)

#p2pa2023 <- predict(rfpa, test2023)
#confusionMatrix(p2pa2023, test2023$pre_abs)
